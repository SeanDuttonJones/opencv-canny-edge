...
cv.imwrite("./images/sobel_x@2x.jpg", img_sobelx)
cv.imwrite("./images/sobel_y@2x.jpg", img_sobely)
cv.imwrite("./images/sobel_xy@2x.jpg", img_sobelxy)
...
cv.imwrite("./images/canny_edges@2x.jpg", img_edges)